...
export class OneRollDialogHelper {
        ...
        renderTemplate(template, dialogData).then((dlg) => {
            new Dialog({
                ...
                buttons: {
                    roll: {
                     ...
                     callback: (html) => {
                            ...
                            if(dialogData.type === "pw") {
                                rollData = this.buildPowerRollData(html, dialogData.actor);
                            } else {
                ...
                render: (html) => {
                    ...
                    let display = countExpertDice(chosenStat, chosenSkill);
    ...
    countExpertDice(chosenStat, chosenSkill) {
        let chosenSkillEd = 0;
        let displayMode = "";
        if(chosenSkill != "none") {
    ...
    buildTraitRollData(html, actorId) {
